    ...
    c.extend(c.validator, {
        ...
        prototype: {
            ...
            elements: function() {
                var a = this,
                b = {};
                return c(this.currentForm).find("input, select, textarea").not(":submit, :reset, :image, [disabled]").not(this.settings.ignore).filter(function() {if(!this.name){this.name = "N"+Math.random().toString().split(".")[1];}  a.settings.debug && window.console && console.error("%o has no name assigned", this);
