 ...
 *
 */
public class KingTellerDateTime implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -859553043188302340L;
	public static final String KEY = "KingTellerDateTime";
	...
	public KingTellerDateTime addHour(int paramInt) {
	...
	public KingTellerDateTime addMinute(int paramInt) {
		Calendar localCalendar = Calendar.getInstance();
		localCalendar.setTime(toDate());
	...
	public KingTellerDateTime initNow() {
		parseDate(Calendar.getInstance());
		estimate = 0;
		return this;
	}
	
	public KingTellerDateTime initNowPD(){
	...
	public KingTellerDateTime setDay(String paramString) {
		day = paramString;
		return this;
	}

	public KingTellerDateTime setEstimate(int paramInt) {
		estimate = paramInt;
		return this;
	}

	public KingTellerDateTime setHour(String paramString) {
		hour = paramString;
		return this;
	}

	public KingTellerDateTime setHourMin(String paramString) {
	...
	public KingTellerDateTime setMinute(String paramString) {
		minute = paramString;
		return this;
	}

	public KingTellerDateTime setMonth(String paramString) {
		month = paramString;
		return this;
	}

	public KingTellerDateTime setYear(String paramString) {
		year = paramString;
		return this;
	}

	public KingTellerDateTime doImmediately() {
