...
public class ATMCodeBean implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3369684508034477830L;
	...
	public String toString() {
		...
		stringBuffer.append("机器编号：<font color='#666666'>"+getJqbh()+"</font>");
		stringBuffer.append("<br />ATM号：<font color='#666666'>"+getAtmh()+"</font>");
		stringBuffer.append("<br />网点地址：<font color='#666666'>"+getWddz()+"</font>");
		stringBuffer.append("<br />网点联系人：<font color='#666666'>"+getWdlxr()+"</font>");
		stringBuffer.append("<br />网点联系人电话：<font color='#666666'>"+getWdlxdh()+"</font>");
		stringBuffer.append("<br />网点设备简称：<font color='#666666'>"+getWdsbjc()+"</font>");
		stringBuffer.append("<br />机型名称：<font color='#666666'>"+getJxName()+"</font>");
