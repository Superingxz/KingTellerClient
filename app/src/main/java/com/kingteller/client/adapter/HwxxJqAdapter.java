...
public class HwxxJqAdapter extends BaseAdapter{
	...
	public HwxxJqAdapter(Context context,List<LogisticObjectBean> hwList){
	...
	public View getView(final int postion, View v, ViewGroup arg2) {
		...
		if (v == null) {
			...
			v = inflater.inflate(R.layout.item_add_wcwh, null);
			viewHoler.hwId = (TextView) v.findViewById(R.id.hwId);
		...
		viewHoler.hwId.setText(hw.getHwId());
