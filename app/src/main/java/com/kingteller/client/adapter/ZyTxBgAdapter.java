...
public class ZyTxBgAdapter extends BaseAdapter {
	...
	private ZyHwxxAdapter adapter;

	public ZyTxBgAdapter(Context context,
	...
	public View getView(final int postion, View v, ViewGroup arg2) {
		...
		if (v == null) {
			...
			v = inflater.inflate(R.layout.item_add_zytxbg, null);
		...
		adapter = new ZyHwxxAdapter(context, tyd.getHwList());
