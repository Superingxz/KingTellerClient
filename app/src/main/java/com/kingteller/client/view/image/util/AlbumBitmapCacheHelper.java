package com.kingteller.client.view.image.util;
        ...
        tpe.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (width == 0 || height == 0) {
                    ...
                    options.inSampleSize = computeScale(options, ((WindowManager) (KingTellerApplication.getApplication().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth(),
