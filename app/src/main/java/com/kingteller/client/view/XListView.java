...
public class XListView extends ListView implements OnScrollListener {
	...
	private final static String RefreshTimeShare="RefreshTimeShare";
	...
	private void initWithContext(Context context) {
		share = context.getSharedPreferences(RefreshTimeShare, Context.MODE_PRIVATE);
	...
	private void setRefreshTime() {
		share.edit().putLong(RefreshTimeName+"_RefreshTime", new Date().getTime());
	}
	...
	public void setOnRefreshListener(IXListViewListener l) {
		mListViewListener = l;
	}

	public String getRefreshTimeName() {
		return RefreshTimeName;
	}

	public void setRefreshTimeName(String refreshTimeName) {
		RefreshTimeName = refreshTimeName;
	}
