...
import com.kingteller.client.view.image.model.ImageDirectoryModel;
...
public class PickOrTakeImageActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_pick_or_take_image);
        initView();
        initData();
    }
...
//        window.setBackgroundDrawable(getResources().getDrawable(R.color.white));
    ...
    protected void initData() {
        ...
        tv_choose_image_directory.setText("全部图片");
        ...
        //计算每张图片应该显示的宽度
        perWidth = (((WindowManager) (KingTellerApplication.getApplication().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth() - CommonUtil.dip2px(this, 4))/3;
            ...
            public void run() {
                ...
                if (cursor != null){
                    ...
                    while (cursor.moveToNext()){
                        ...
                        if(singleImageModel.path.contains("/kingteller/imagecache")){
                            return;
                         }
	...
	public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        if (requestCode == CODE_FOR_WRITE_PERMISSION){
            if (permissions[0].equals(Manifest.permission.WRITE_EXTERNAL_STORAGE)
				...
				KingTellerPromptDialogUtils.showOnePromptDialog(dialog, "该相册需要赋予访问存储的权限, 不开启将无法正常工作!",
    					new OnBtnClickL() {
    						@Override
...
//                finish();
    ...
    private class GridViewAdapter extends BaseAdapter{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (currentShowPosition == -1 && i==0){
                ...
                ((ImageView)view).setBackgroundResource(R.drawable.ic_selectpic_photo);
            ...
            if(view==null || view.getTag()==null){
                view = inflater.inflate(R.layout.item_selectpic_pic_up_image, null);
            ...
            if (getImageDirectoryModelStateFromMapById(i)){
                ...
                holder.iv_pick_or_not.setImageResource(R.drawable.ic_checkbox_three_pressed);
            }else{
                holder.v_gray_masking.setVisibility(View.GONE);
                holder.iv_pick_or_not.setImageResource(R.drawable.ic_checkbox_three_nomal);
            }
            //优化显示效果
            ...
            if (bitmap != null){
                ...
                holder.iv_content.setBackgroundResource(R.drawable.ic_selectpic_load);
            }
            return view;
        }
    }
    ...
    private void takePic(){
        ...
        String time = KingTellerTimeUtils.getConversionFormatStringByDate(new Date(), 0);
        String Path = KingTellerStaticConfig.CACHE_PATH.SD_KTIMAGE + "/";
       
        String picname =  CommonUtil.md5(Path + "_" + time);
        tempPath = Path + picname + ".jpg";
    ...
    private class ListviewAdapter extends BaseAdapter{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            if(view==null || view.getTag()==null){
                view = inflater.inflate(R.layout.item_selectpic_album_directory, null);
            ...
            if(getItemViewType(i) == 0){
                holder.tv_directory_name.setText("全部图片" + "   ");
                int size = 0;
            ...
            if (bitmap != null){
                ...
                holder.iv_directory_pic.setBackgroundResource(R.drawable.ic_selectpic_load);
            }
            return view;
        }
    }
            ...
            if (i == R.id.iv_content) {
                ...
                if (getImageDirectoryModelStateFromMapById(position)) {
                    if (currentPicNums == picNums) {
                        toggleImageDirectoryModelStateFromMapById(position);
                        T.showShort(PickOrTakeImageActivity.this, String.format("你最多只能选择%1$d张照片", picNums));
                        return;
                    }
                    picklist.add(getImageDirectoryModelUrlFromMapById(holder.position));
                    holder.iv_pick_or_not.setImageResource(R.drawable.ic_checkbox_three_pressed);
                    ...
                    tv_preview.setText(String.format("预览(%1$d)", currentPicNums));
                    btn_choose_finish.setText(String.format("完成(%1$d/%2$d)", currentPicNums, picNums));
                } else {
...
//                    adapter.notifyDataSetChanged();
        ...
        switch (requestCode){
                    ...
                    for (String path : temp){
                        if (!picklist.contains(path)){
                            ...
                            if(v != null) {
                                ...
                                ((ImageView) ((ViewGroup) (v.getParent())).findViewById(R.id.iv_pick_or_not)).setImageResource(R.drawable.ic_checkbox_three_pressed);
                            }
                    ...
                    for (String path : picklist){
                        if (!temp.contains(path)){
                            ...
                            if(v != null) {
                                ...
                                ((ImageView) ((ViewGroup) (v.getParent())).findViewById(R.id.iv_pick_or_not)).setImageResource(R.drawable.ic_checkbox_three_nomal);
                            }
                            currentPicNums --;
            ...
            case CODE_FOR_TAKE_PIC:
                if (resultCode == RESULT_OK){
                    //临时文件的文件名
                	//T.showLong(this, "拍照的图片 " + tempPath);
                	...
                	ArrayList<String> pick_pz = new ArrayList<String>();
                	pick_pz.add(tempPath);
                	
                	AlbumBitmapCacheHelper.getInstance().clearCache();
                	
                	Intent intent_pic = new Intent();
                    intent_pic.putExtra("pic_dataList", new Gson().toJson(pick_pz));
    ...
    private void returnDataAndClose(){
        AlbumBitmapCacheHelper.getInstance().clearCache();
        if (currentPicNums == 0){
        	T.showShort(this, "你还没有选择任何图片");
            return;
        }
        
        Intent intent_pic = new Intent();
        intent_pic.putExtra("pic_dataList", new Gson().toJson(picklist));
		setResult(RESULT_OK, intent_pic);
		finish();
    }
