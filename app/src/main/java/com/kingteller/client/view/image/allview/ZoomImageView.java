...
public class ZoomImageView extends ImageView {
    ...
    public void setSourceImageBitmap(Bitmap bitmap, Activity activity) {
        sourceBitmap = bitmap;
        int screenWidth = ((WindowManager) (KingTellerApplication.getApplication().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth();
        int screenHeight = ((WindowManager) (KingTellerApplication.getApplication().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getHeight();
