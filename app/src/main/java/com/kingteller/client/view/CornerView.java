...
public class CornerView extends TextView {
     ...
     */
	public CornerView(Context context, View target) {
     ...
     */
	public CornerView(Context context, TabWidget target, int index) {
	...
	public CornerView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
