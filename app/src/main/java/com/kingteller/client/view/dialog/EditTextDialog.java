...
import com.kingteller.client.view.dialog.base.BaseDateDialog;
import com.kingteller.client.view.dialog.base.BaseEditTextDialog;
import com.kingteller.client.view.dialog.utils.CornerUtils;

public class EditTextDialog extends BaseEditTextDialog<EditTextDialog>{
    ...
    public View onCreateView() {
        ...
        edit_title.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT,
        			LinearLayout.LayoutParams.WRAP_CONTENT));
        ll_EditTextLayout.addView(edit_title);
        
        edit_content.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT,
    			LinearLayout.LayoutParams.WRAP_CONTENT, 1));
        ll_EditTextLayout.addView(edit_content);
    
        ll_container.addView(ll_EditTextLayout);
    ...
    public void setUiBeforShow() {
        ...
        ll_EditTextLayout.setPadding(dp2px(10), dp2px(0), dp2px(10), dp2px(0));
    ...
    /** set style(设置style) */
    public EditTextDialog style(int style) {
        this.style = style;
        return this;
    }

    /** set title underline color(设置标题下划线颜色) */
    public EditTextDialog titleLineColor(int titleLineColor) {
        this.titleLineColor = titleLineColor;
        return this;
    }

    /** set title underline height(设置标题下划线高度) */
    public EditTextDialog titleLineHeight(float titleLineHeight_DP) {
        this.titleLineHeight_DP = titleLineHeight_DP;
        return this;
    }

    /** set divider color between btns(设置btn分割线的颜色) */
    public EditTextDialog dividerColor(int dividerColor) {
