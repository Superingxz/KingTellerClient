...
import com.kingteller.client.view.DatePickView.PickerDateListener;
import com.kingteller.client.view.DateTimePickView.PickerDateTimeListener;
import com.kingteller.client.view.TimePickView.PickerTimeListener;
...
public class PickDialog extends Dialog {
	...
	public PickDialog(Context context,
			PickerTimeListener paramPickerTimeListener, String titlestr) {
		super(context, R.style.PickDialog);
		mContext = context;
	...
	private void initTimeView(PickerTimeListener pickerTimeListener,
			String titlestr) {
