...
public class LogisticsReportActivity extends BaseReportActivity{
	...
	public void initUI() {
		...
		if(KingTellerJudgeUtils.isEmpty(isCheckout)){	
			switch (optType) {
			case OPT_ADUIT:
				title_text.setText("物流报告审核");
				break;
			default:
				title_text.setText("物流报告填写");
				break;
			}
		}else{
	...
	public void initData() {
		...
		if (data == null || optType != 0 || data.getReportData() == null)
			...
			setDataInfo(KingTellerDbUtils.getReportDataFromString(data.getReportData(), LogisticsReportBean.class));
		}
	}
	...
	public void getReportInfo() {
		...
		fh.post(KingTellerConfigUtils.CreateUrl(this, KingTellerUrlConfig.WebQtbgUrl),
				params, new AjaxHttpCallBack<LogisticsReportBean>(this, true) {
					...
					@Override
					public void onStart() {
						KingTellerProgressUtils.showProgress(LogisticsReportActivity.this, "数据加载中...");
					}
