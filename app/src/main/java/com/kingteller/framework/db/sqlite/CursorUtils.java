package com.kingteller.framework.db.sqlite;
...
import com.kingteller.framework.db.table.Property;
...
public class CursorUtils {
	...
	public static <T> T getEntity(Cursor cursor, Class<T> clazz,KingTellerDb db){
		try {
			if(cursor!=null ){
