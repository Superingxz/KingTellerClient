...
import com.kingteller.framework.http.entityhandler.EntityCallBack;
import com.kingteller.framework.http.entityhandler.FileEntityHandler;
import com.kingteller.framework.http.entityhandler.StringEntityHandler;
	...
	private void handleResponse(HttpResponse response) {
		...
		if (status.getStatusCode() >= 300) {
			...
			try {
				...
				callback.SetHeaders(response.getAllHeaders());
