...
import com.kingteller.framework.bitmap.core.BitmapCache;
import com.kingteller.framework.bitmap.core.BitmapDisplayConfig;
import com.kingteller.framework.bitmap.core.BitmapProcess;
import com.kingteller.framework.bitmap.display.Displayer;
import com.kingteller.framework.bitmap.display.SimpleDisplayer;
import com.kingteller.framework.bitmap.download.Downloader;
import com.kingteller.framework.bitmap.download.SimpleDownloader;
import com.kingteller.framework.core.AsyncTask;
...
public class KingTellerBitmap {
	...
	private static KingTellerBitmap mFinalBitmap;
	
	////////////////////////// config method start////////////////////////////////////
	private KingTellerBitmap(Context context) {
		mContext = context;
	 ...
	 * @return
	 */
	public static synchronized KingTellerBitmap create(Context ctx){
		if(mFinalBitmap == null){
			mFinalBitmap = new KingTellerBitmap(ctx.getApplicationContext());
		}
		return mFinalBitmap;
	}
	 ...
	 * @param bitmap
	 */
	public KingTellerBitmap configLoadingImage(Bitmap bitmap) {
	 ...
	 * @param bitmap
	 */
	public KingTellerBitmap configLoadingImage(int resId) {
	 ...
	 * @param bitmap
	 */
	public KingTellerBitmap configLoadfailImage(Bitmap bitmap) {
	 ...
	 * @param resId
	 */
	public KingTellerBitmap configLoadfailImage(int resId) {
	 ...
	 * @param bitmapHeight
	 */
	public KingTellerBitmap configBitmapMaxHeight(int bitmapHeight){
	 ...
	 * @param bitmapHeight
	 */
	public KingTellerBitmap configBitmapMaxWidth(int bitmapWidth){
	 ...
	 * @return
	 */
	public KingTellerBitmap configDownlader(Downloader downlader){
	 ...
	 * @return
	 */
	public KingTellerBitmap configDisplayer(Displayer displayer){
	 ...
	 * @return
	 */
	public KingTellerBitmap configDiskCachePath(String strPath){
	 ...
	 * @param size 缓存大小
	 */
	public KingTellerBitmap configMemoryCacheSize(int size){
	 ...
	 */
	public KingTellerBitmap configMemoryCachePercent(float percent){
	 ...
	 * @param size
	 */
	public KingTellerBitmap configDiskCacheSize(int size){
	 ...
	 * @param size
	 */
	public KingTellerBitmap configBitmapLoadThreadSize(int size){
		if(size >= 1)
	 ...
	 * @return
	 */
	public KingTellerBitmap configRecycleImmediately(boolean recycleImmediately){
    ...
    /**
     * 执行过此方法后,KingTellerBitmap的缓存已经失效,建议通过FinalBitmap.create()获取新的实例
     * @author fantouch
     */
     ...
     * 执行过此方法后,FinalBitmap的缓存已经失效,建议通过KingTellerBitmap.create()获取新的实例
     * 
     * @author fantouch
     */
    ...
    /**
     * 关闭缓存
     * 执行过此方法后,KingTellerBitmap的缓存已经失效,建议通过KingTellerBitmap.create()获取新的实例
     * @author fantouch
     */
	...
	/**
	 * @title 配置信息
	 * @description KingTellerBitmap的配置信息
