...
public class KingTellerHttp {
    ...
    */
	...
	public void post(String url,AjaxFilesParams params, AjaxCallBack<? extends Object> callBack){
		post(url, paramsToEntity(params,callBack), null, callBack);
	}
  ...
  //------------------put 请求-----------------------
    ...
    private HttpEntity paramsToEntity(AjaxFilesParams params,AjaxCallBack<? extends Object> callBack) {
        HttpEntity entity = null;
