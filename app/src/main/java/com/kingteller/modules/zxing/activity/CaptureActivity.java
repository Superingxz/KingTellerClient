package com.kingteller.modules.zxing.activity;
...
import com.kingteller.client.view.dialog.BarCodeEditDialog;
...
import com.kingteller.modules.zxing.core.BitmapQRCodeUtils;
import com.kingteller.modules.zxing.core.CaptureActivityHandler;
import com.kingteller.modules.zxing.view.ViewfinderView;
import com.kingteller.modules.zxing.executor.AmbientLightManager;
import com.kingteller.modules.zxing.executor.BeepManager;
import com.kingteller.modules.zxing.executor.FinishListener;
import com.kingteller.modules.zxing.executor.InactivityTimer;
...
public final class CaptureActivity extends Activity implements
	...
	public void onActivityResult(int requestCode, int resultCode, final Intent intent) {
		if (resultCode == RESULT_OK) {
			...
			switch (requestCode) {
				case KingTellerStaticConfig.QRCODE_PICTURE_NUM:
					// 获取选中图片的路径
	...
	public void onClick(View view) {
		...
		case R.id.capture_back:
			finish();
			break;
		case R.id.capture_btn_picture:
			// 打开手机中的相册
			Intent innerIntent = new Intent(Intent.ACTION_GET_CONTENT); // "android.intent.action.GET_CONTENT"
			innerIntent.setType("image/*");
			Intent wrapperIntent = Intent.createChooser(innerIntent, "选择二维码图片");
			this.startActivityForResult(wrapperIntent, KingTellerStaticConfig.QRCODE_PICTURE_NUM);
			break;
			
		case R.id.capture_btn_qrcode:
			onPause();
			...
			edit_dialog.show();
			break;
		case R.id.capture_relayout_smewm:
			...
			break;
		case R.id.capture_relayout_smtxm:
			...
			break;
		case R.id.capture_relayout_dksgd:
